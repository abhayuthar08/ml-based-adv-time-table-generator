...
//   const [classInput, setClassInput] = useState("");
//   const [roomInput, setRoomInput] = useState("");
//   const [labLocationInput, setLabLocationInput] = useState(""); // New state for lab locations
//   const [batchInput, setBatchInput] = useState(""); // New state for batches
//   const [subjectInput, setSubjectInput] = useState("");
//   const [subjectTeachersInput, setSubjectTeachersInput] = useState("");
//   const [weeklyClassesInput, setWeeklyClassesInput] = useState("");
...
const GenerateTimetable = () => {
  ...
  const [subjectTeachersInput, setSubjectTeachersInput] = useState("");
  const [weeklyClassesInput, setWeeklyClassesInput] = useState("");
  const [labTimingInput, setLabTimingInput] = useState(""); // New state for lab timings
